        ...
        return $table
            ...
            ->filters([
                TernaryFilter::make('is_active')->label('Statut')
                    ->trueLabel('Publiées')->falseLabel('En attente'),
            ])
            ->recordActions([
                EditAction::make(),
                Action::make('valider')
                ...
                Action::make('rejeter')
                    ...
                    ->form([
                        Textarea::make('motif_rejet')
                            ->label('Motif du refus (envoyé par email au professionnel)')
                    ...
                    ->after(fn () => Notification::make()->title('Annonce rejetée')->warning()->send()),
            ])
            ->toolbarActions([
